...
const sourceSpecs = [
  ...
  { id: 'event_extraction_profile', file: 'lib/memory.js', label: '事件抽取配置与消歧窗口', start: 'export function getEventExtractionProfile', end: 'export async function extractAndCommitMemory' },
  { id: 'event_extraction_prompt', file: 'lib/memory.js', label: '轮后记忆抽取提示词与模型调用', start: 'export async function extractAndCommitMemory', end: 'const changes = [];' },
