...
const sourceSpecs = [
  ...
  { id: 'hybrid_retrieval', file: 'lib/memory.js', label: '纠正式召回、LLM 规划、跨候选池改写与图谱证据展开', start: 'export function getRetrievalProfile', end: 'export function formatRetrievedMemory' },
